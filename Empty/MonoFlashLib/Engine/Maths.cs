...
namespace MonoFlash.Engine
{
    public class Maths
    {
        ...
        {
            var target1 = b;
            var target2 = -(Math.PI * 2 - b);

            if (Math.Abs(a - target1) < Math.Abs(a - target2)) return target1;
            return target2;
        }
        ...
        public static double easeInOutQuint(double t, double b, double f)
        {
            var c = f - b;
            var d = 1;
            if ((t /= d / 2f) < 1) return c / 2 * t * t * t * t * t + b;
        ...
        public static double easeInOutCubic(double t, double b, double f)
        {
            var c = f - b;
            var d = 1;
            if ((t /= d / 2f) < 1) return c / 2 * t * t * t + b;
