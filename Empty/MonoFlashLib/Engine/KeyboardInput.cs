...
namespace MonoFlash.Engine
{
	...
	public static class KeyboardInput
	{
		...
		private static bool JustPressed(KeyboardState keyState, Keys key) => keyState.IsKeyDown(key) && prevKeyState.IsKeyUp(key);

		private static bool JustReleased(KeyboardState keyState, Keys key) => prevKeyState.IsKeyDown(key) && keyState.IsKeyUp(key);
