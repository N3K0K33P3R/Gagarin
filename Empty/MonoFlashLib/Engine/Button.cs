...
namespace MonoFlash.Engine
{
    public class Button : Sprite
    {
        ...
        private bool startedHover, wasAbandonedByMouse = true;
        private string text;
        ...
        public Button(string text, int width, int height, SpriteFont font, uint colorBorder, uint colorInner,
            uint colorHover, uint textBase, uint textHover)
        {
            this.text = text;
        ...
        public override void Update(float delta)
        {
                ...
                prevState != ButtonState.Pressed)
            {
                ...
                if (rect.Intersects(touchRect) && onClick != null) onClick(this);
            }
        ...
        {
            var color1 = Colors.hexToRGB(colorInnerCurrent);
            var color2 = Colors.hexToRGB(this.color1);
            var drawRect = rect;
