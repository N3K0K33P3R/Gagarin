    ...
    public static class Primitives2D
    {
            ...
            float thickness, float layerDepth)
        {
            ...
            for (var i = 1; i < points.Count; i++)
                DrawLine(spriteBatch, points[i - 1] + position, points[i] + position,
                    color, thickness, 1f / layerDepth);
        }
        ...
        private static List<Vector2> CreateCircle(double radius, int sides)
        {
            ...
            List<Vector2> result;
            if (circleCache.TryGetValue(circleKey, out result)) return result;
        ...
        private static List<Vector2> CreateArc(float radius, int sides, float startingAngle, float radians)
        {
            ...
            List<Vector2> result;
            if (arcCache.TryGetValue(arcKey, out result)) return result;
        ...
        /// <param name="layerDepth">The layer depth.</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Color color,
            float angle, float layerDepth, Vector2 origin)
        {
            Vector2 originPos;
            if (origin == null)
            ...
            // stretch the pixel between the two vectors
            spriteBatch.Draw(spriteBatch.GetWhitePixel(), location, null, color,
                angle, originPos, size, SpriteEffects.None,
                layerDepth == 0f ? 0f : 1f / layerDepth);
        }
        ...
        public static void FillRectangle(this SpriteBatch spriteBatch, float x, float y, float w, float h, Color color,
            float layerDepth)
        {
            FillRectangle(spriteBatch, new Vector2(x, y), new Vector2(w, h),
                color, 0.0f, layerDepth, Vector2.Zero);
        }
        ...
        {
            FillRectangle(spriteBatch, new Vector2(x, y), new Vector2(w, h),
                color, angle, layerDepth, Vector2.Zero);
        }
            ...
            float layerDepth)
        {
            ...
            DrawLine(spriteBatch, new Vector2(rect.X, rect.Y),
                new Vector2(rect.Right, rect.Y), color, thickness,
                layerDepth); // top
            DrawLine(spriteBatch, new Vector2(rect.X + 1f, rect.Y),
                new Vector2(rect.X + 1f, rect.Bottom + thickness), color,
                thickness, layerDepth); // left
            DrawLine(spriteBatch, new Vector2(rect.X, rect.Bottom),
                new Vector2(rect.Right, rect.Bottom), color, thickness,
                layerDepth);
            // bottom
            DrawLine(spriteBatch, new Vector2(rect.Right + 1f, rect.Y),
                new Vector2(rect.Right + 1f, rect.Bottom + thickness),
                color, thickness, layerDepth); // right
        }
            ...
            float layerDepth)
        {
            DrawRectangle(spriteBatch,
                new Rectangle((int) location.X, (int) location.Y, (int) size.X, (int) size.Y), color,
                1.0f, layerDepth);
        }
        ...
        public static void DrawLine(this SpriteBatch spriteBatch, float x1, float y1, float x2, float y2, Color color,
            float layerDepth)
        {
            DrawLine(spriteBatch, new Vector2(x1, y1), new Vector2(x2, y2),
                color, 1f, layerDepth);
        }
            ...
            float thickness, float layerDepth)
        {
            ...
            spriteBatch.Draw(spriteBatch.GetWhitePixel(),
                ...
                SpriteEffects.None, layerDepth == 0f ? 0f : 1f / layerDepth);
        }
        ...
        public static void DrawCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides,
            ...
            float layerDepth)
        {
            DrawPoints(spriteBatch, center, CreateCircle(radius, sides),
                color, 1.0f, layerDepth);
        }
        ...
        {
            DrawPoints(spriteBatch, new Vector2(x, y),
                CreateCircle(radius, sides), color, 1.0f,
                layerDepth);
        }
        ...
        {
            DrawPoints(spriteBatch, new Vector2(x, y),
                CreateCircle(radius, sides), color, thickness,
                layerDepth);
        }
