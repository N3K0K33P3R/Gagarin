	...
	public class Cursor
	{
		...
		public void Draw(SpriteBatch spriteBatch)
		{
			...
			if (selectedChar.HasValue)
			{
				...
				{
					spriteBatch.Draw(
						spriteBatch.GetWhitePixel(),
						new Rectangle(cp.X, cp.Y, sc.X - cp.X, textBox.Renderer.Font.LineSpacing),
						Icon,
						Selection);
				}
				else
				{
					spriteBatch.Draw(
						spriteBatch.GetWhitePixel(),
						new Rectangle(sc.X, sc.Y, cp.X - sc.X, textBox.Renderer.Font.LineSpacing),
						Icon,
						Selection);
				}
			}
			...
			spriteBatch.Draw(
				spriteBatch.GetWhitePixel(),
				new Rectangle(cp.X, cp.Y, Icon.Width, textBox.Renderer.Font.LineSpacing),
				Icon,
				Color);
		}
