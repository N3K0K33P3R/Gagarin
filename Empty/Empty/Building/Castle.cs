...
namespace Empty.Building
{
	public class Castle
	{
		...
		public void Draw(SpriteBatch spriteBatch)
		{
			...
			float width = Values.TILE_SIZE * 3 * Healty / 1000;

			spriteBatch.FillRectangle(rect.Location.ToVector2() - new Vector2(0, Values.TILE_SIZE/2), new Vector2(width, Values.TILE_SIZE / 4), Color.Green, 0);
		}
